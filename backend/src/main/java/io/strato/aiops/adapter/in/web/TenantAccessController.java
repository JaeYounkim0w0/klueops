...
public class TenantAccessController {
    ...
    /** TenantAccessController 인스턴스를 필요한 의존성과 초기 상태로 구성한다. */
    ...
    /** TenantAccessController의 access 처리에 필요한 업무 로직을 수행한다. */
    ...
    /** TenantAccessController의 members 처리에 필요한 업무 로직을 수행한다. */
    ...
    /** TenantAccessController의 invite 처리에 필요한 업무 로직을 수행한다. */
    ...
    /** TenantAccessController의 updateMember 처리 대상의 상태를 갱신한다. */
    ...
    /** TenantAccessController의 offboardPlan 처리에 필요한 업무 로직을 수행한다. */
    ...
    /** TenantAccessController의 offboard 처리에 필요한 업무 로직을 수행한다. */
    ...
    /** TenantAccessController의 features 처리에 필요한 업무 로직을 수행한다. */
    ...
    /** TenantAccessController의 updateFeature 처리 대상의 상태를 갱신한다. */
    ...
    /** TenantAccessController의 mappings 처리 데이터를 필요한 표현으로 변환한다. */
    ...
    /** TenantAccessController의 createMapping 처리에 필요한 데이터를 생성하거나 저장한다. */
    ...
    /** TenantAccessController의 updateMapping 처리 대상의 상태를 갱신한다. */
    ...
    /** TenantAccessController의 deleteMapping 처리 대상과 관련 상태를 안전하게 정리한다. */
    ...
    /** TenantAccessController의 requireTenant 처리 입력과 현재 상태의 유효성을 검증한다. */
    ...
    public record InviteMemberRequest(@NotBlank String issuer, String subject, String email,
        ...
        /** InviteMemberRequest의 scope 처리에 필요한 업무 로직을 수행한다. */
    ...
    public record CreateGroupMappingRequest(@NotBlank String issuer, @NotBlank String groupValue,
                                            @NotNull PlatformRole role, @NotNull ScopeType scopeType,
                                            UUID workspaceId, UUID clusterId, String namespace) {
        /** CreateGroupMappingRequest의 scope 처리에 필요한 업무 로직을 수행한다. */
        AccessScope scope(UUID tenantId) {
            return scoped(tenantId, scopeType, workspaceId, clusterId, namespace);
        }
    }
    ...
    public record MemberResponse(String id, String tenantId, String userId, String username, String displayName,
        ...
        /** MemberResponse의 from 처리 데이터를 필요한 표현으로 변환한다. */
    ...
    public record GroupMappingResponse(String id, String issuer, String groupValue, String tenantId, String role,
        ...
        /** GroupMappingResponse의 from 처리 데이터를 필요한 표현으로 변환한다. */
    ...
    public record AccessResponse(String platformRole, String tenantId, String workspaceId,
        ...
        /** AccessResponse의 from 처리 데이터를 필요한 표현으로 변환한다. */
    ...
    /** TenantAccessController의 scoped 처리에 필요한 업무 로직을 수행한다. */
    ...
    /** TenantAccessController의 value 처리에 필요한 업무 로직을 수행한다. */
