create table deployment_plans (
    id uuid primary key,
    application_id uuid references managed_applications(id),
    ...
    create_namespace boolean not null,
    exposure_type varchar(30) not null,
    hostname varchar(253),
    exposure_path varchar(255),
    backend_service_name varchar(253),
    backend_service_port integer,
    gateway_name varchar(253),
    gateway_namespace varchar(253),
