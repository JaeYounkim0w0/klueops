...
class TenantAccessApiTest {
    ...
    /** TenantAccessApiTest의 invitesTenantOperatorAndResolvesSelectedScopeCapabilities 처리에 필요한 업무 로직을 수행한다. */
    @Test
    ...
    /** TenantAccessApiTest의 managesExplicitGroupMappingAndRejectsMandatoryFeatureDisable 처리에 필요한 업무 로직을 수행한다. */
    @Test
    ...
    /** TenantAccessApiTest의 disabledTenantFeatureBlocksBothNavigationAndDirectApi 처리에 필요한 업무 로직을 수행한다. */
    @Test
    ...
    /** TenantAccessApiTest의 setFeature 처리 대상의 상태를 갱신한다. */
    ...
    /** TenantAccessApiTest의 login 처리에 필요한 업무 로직을 수행한다. */
