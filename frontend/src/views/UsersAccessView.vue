...
/** scopeFields 처리에 필요한 화면 또는 업무 로직을 수행한다. */
...
/** inviteMember 처리에 필요한 화면 또는 업무 로직을 수행한다. */
...
/** addGroup 처리에 필요한 데이터를 생성하거나 저장한다. */
...
/** toggleMember 처리 데이터를 화면 또는 API 표현으로 변환한다. */
...
/** prepareOffboard 처리에 필요한 화면 또는 업무 로직을 수행한다. */
...
/** executeOffboard 처리의 핵심 작업 흐름을 실행한다. */
...
/** toggleMapping 처리 데이터를 화면 또는 API 표현으로 변환한다. */
...
/** prepareMappingDelete 처리에 필요한 화면 또는 업무 로직을 수행한다. */
...
/** deleteMapping 처리 대상과 관련 상태를 안전하게 정리한다. */
...
/** toggleFeature 처리 데이터를 화면 또는 API 표현으로 변환한다. */
