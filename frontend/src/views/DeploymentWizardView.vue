...
const target = reactive({ clusterId: '', namespace: 'default', createNamespace: false, releaseName: '', exposureType: 'NONE' as ExposureType, hostname: '', exposurePath: '/', backendServiceName: '', backendServicePort: 80, gatewayName: '', gatewayNamespace: 'default' });
